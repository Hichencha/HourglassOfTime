...
///**
// * Desc:  摇摆
// * Author: http://blog.csdn.net/qq_26411333/article/details/52421086
// * Date: 16/12/20
// */
//
...
//
//    private int stroke = 3; //线段的宽度
//    private int r = 18;    //圆圈的半径
//    private int length = 180; //线的长度
//    private int number = 1; //球的个数（奇数，偶数感觉丑就没实现）
//    private static int angle = 20;//最大旋转角度
//
...
//        linePaint.setStyle(Paint.Style.FILL_AND_STROKE);
//        linePaint.setColor(Color.parseColor("#FFB805"));
//    }
//}